  ...
  return (
    <div className="banner" id="banner">
      ...
      <div className="banner-text">
        ...
        <p>
          Currently work as an indepedant.Highly motivated and committed to good
          working knowledge and the ability to learn new technology quickly,
          with a background in project management that possesses a high degree
          of problem-solving and teamwork skills.
        </p>
